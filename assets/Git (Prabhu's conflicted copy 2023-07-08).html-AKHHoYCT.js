...
</code></pre></div><p>Issues:</p><ul><li><code>error: some local refs could not be updated</code>, to resolve this first <a href="#prune-stale-branches">prune remote branches</a>, then pull</li></ul><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token parameter variable">-c</span> <span class="token assign-left variable">fetch.parallel</span><span class="token operator">=</span><span class="token number">0</span> <span class="token parameter variable">-c</span> <span class="token assign-left variable">submodule.fetchJobs</span><span class="token operator">=</span><span class="token number">0</span> pull <span class="token parameter variable">--progress</span> <span class="token string">&quot;origin&quot;</span> +ref/heads/master
...
</code></pre></div></li></ul><p>Ideas on what to ignore:</p>`,65),b=a("li",null,"Compiled source code",-1),v=a("li",null,"Packages and compressed files",-1),y=a("li",null,"Logs and databases",-1),w=a("li",null,"OS generated files",-1),x={href:"https://github.com/github/gitignore",target:"_blank",rel:"noopener noreferrer"},S=t(`<p>Globally ignore files:</p><ul><li>Ignore files in all repositories</li><li>Settings are not tracked in repo</li><li>User specific instead of repository specific</li></ul><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> core.excludesfile ~/.gitignore_global
